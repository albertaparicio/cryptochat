...
# hour using raw_input to compute gross pay. Award time-and-a-half 
# for the hourly rate for all hours worked above 40 hours. Put the 
# logic to do the computation of time-and-a-half in a function 
